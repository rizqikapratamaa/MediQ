...
const ProfilePembayaran = ({doctorData}) => {
    ...
    const [Appointement, setAppointment] = useState(doctorData)
        ...
        <div className="text-poppins my-3 font-poppins">
            ...
            <div className="bg-gradient-to-b from-[#B4F0EF] border-t-2 border-[#B4F0EF]  border-solid to-[#E7F7FA] rounded-xl mt-4 max-md:h-auto flex flex-col gap-5">
                ...
                <div className="flex-col w-full">
                    <div className="flex -translate-y-5 w-full relative mb-4">
                        <div className="flex flex-row bg-white h-9 w-64 justify-around rounded-xl md:w-48 sm:w-56 absolute left-1/2 top-0 -translate-x-1/2 md:text-xs">
                            <div className="flex gap-2 items-center text-[#F21F61] ">
                                <img src={Clock} alt="" className="w-7 h-7"/>
                                {Appointement.hour.time}
                            </div>
                            <img src={Line} alt="Line" />
                            <div className="flex gap-2 items-center text-[#F21F61] ">
                                <img src={Calendar} alt="" className="w-7 h-7"/>
                                {Appointement.dateData}
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col justify-center ml-36 max-md:ml-28 max-md:mt-6">
                        ...
                        <div className="flex gap-2 items-center">
                            ...
                            <p className="text-sm max-md:text-[10px]">Lokasi praktik : {Appointement.location}</p>
                        </div>
            ...
            <div  className="mx-10 mt-10 max-md:p-4 p-8 bg-white rounded-xl -translate-y-5 flex-col max-md:h-32 text-lg max-md:text-xs">
                <div className="justify-between flex mb-4 ">    
                    ...
                    <h1>Rp {Appointement.price},00</h1>
                </div>
                <div className="justify-between flex mb-4 ">    
                    <h1>Biaya admin</h1>
                    <h1>Rp 5.000,00</h1>
