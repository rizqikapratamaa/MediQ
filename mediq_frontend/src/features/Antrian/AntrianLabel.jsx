    ...
    return(
        <div className="mt-5 font-poppins">
            <div className="w-full h-44 from-[#B4F0EF] to-[#E7F7FA] bg-gradient-to-b rounded-xl relative max-md:h-32">
                <div className="absolute bg-[#F21F61] rounded-l-xl rounded-tr-xl w-28 h-8 right-0 text-center text-white flex justify-center items-center max-md:h-6 max-md:w-20 max-md:text-xs ">{data.Distance} km</div>
                <div className="p-5"> 
